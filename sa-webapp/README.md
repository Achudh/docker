...
` $ docker build -f Dockerfile -t achudh/sentiment-analysis-web-app . `

## Running the container
`$ docker run -d -p 8080:8080 -e SA_LOGIC_API_URL='http://localhost:5000' achudh/sentiment-analysis-web-app  `
...
` $ docker push achudh/sentiment-analysis-web-app `
